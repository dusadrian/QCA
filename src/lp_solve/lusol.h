...
#else
  #define LUSOL_MALLOC(bytesize)        ((void *) R_Calloc((size_t) (bytesize), char))
  #define LUSOL_CALLOC(count, recsize)  ((void *) R_Calloc((size_t) ((count) * (recsize)), char))
  #define LUSOL_REALLOC(ptr, bytesize)  ((void *) R_Realloc((char *) (ptr), (size_t) (bytesize), char))
  #define LUSOL_FREE(ptr)               {if((ptr) != NULL) {R_Free(ptr); ptr=NULL;}}
#endif
